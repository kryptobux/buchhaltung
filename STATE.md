...
- **Operator-Aktionen:**
  ...
  - GitHub Pages aktivieren (oder Freigabe an Claude); Eröffnungsbilanzen einbuchen.
- **Betriebsregeln:** ⚠️ JSON-Import der App bis B7 nicht benutzen (hebelt Festschreibung aus) · belege/ + buchungen.csv vertraulich & git-ignoriert · localStorage-Schema nie ohne Migration brechen · GoBD-Features nur mit Freigabe ändern.
